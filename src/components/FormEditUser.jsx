        ...
        <div>
            ...
            <form action="" method="post" className="p-6 flex flex-col rounded-xl bg-neutral-900 border-neutral-600 gap-4 mt-4" onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Name" id="name" className="p-2.5 rounded-lg outline-none placeholder:text-white/50 focus:ring-2 ring-neutral-700" />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="email" className="font-bold text-xl tracking-tighter">Email</label>
                    <input type="email" placeholder="example@mail.com" id="email" className="p-2.5 rounded-lg outline-none placeholder:text-white/50 focus:ring-2 ring-neutral-700" />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="password" className="font-bold text-xl tracking-tighter">Password</label>
                    <input type="password" id="password" className="p-2.5 rounded-lg outline-none placeholder:text-white/50 focus:ring-2 ring-neutral-700" />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="confirmPassword" className="font-bold text-xl tracking-tighter">Confirm Password</label>
                    <input type="password" id="confirmPassword" className="p-2.5 rounded-lg outline-none placeholder:text-white/50 focus:ring-2 ring-neutral-700" />
                </div>
                <div className="flex flex-col gap-2">
